...
func main() {
	...
	go call("func_name_001", 128*1024*1024, 55, 5, 2500)
	go call("func_name_002", 128*1024*1024, 53, 20, 5000)
	go call("func_name_003", 256*1024*1024, 110, 10, 4000)
	go call("func_name_004", 256*1024*1024, 320, 20, 2500)
	go call("func_name_005", 128*1024*1024, 13, 10, 3000)
	go call("func_name_006", 256*1024*1024, 3150, 5, 2500)
	go call("func_name_007", 512*1024*1024, 4430, 5, 3000)
	go call("func_name_008", 512*1024*1024, 8170, 10, 8000)
	go call("func_name_009", 256*1024*1024, 3260, 10, 49000)
	go call("func_name_010", 256*1024*1024, 12130, 20, 50000)
